...
# Source: https://github.com/joeymiller/keel/.github/workflows/release.yml

class Keel < Formula
  desc "Controlled execution governance for AI coding agents"
  homepage "https://github.com/joeymiller/keel"
  url "https://github.com/joeymiller/keel/archive/refs/tags/v0.0.0.tar.gz"
  sha256 "PLACEHOLDER_SHA256_UPDATED_BY_RELEASE_WORKFLOW"
  license "MIT"
  head "https://github.com/joeymiller/keel.git", branch: "main"
